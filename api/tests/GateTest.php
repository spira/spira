...
/**
 * Gate part copypasted from laravel
 * With some changes
 * Class AuthGateGuardTest.
 */
class GateTest extends TestCase
{
    ...
    public function test_policy_default_to_true_if_method_does_not_exist()
    {
        $gate = $this->getBasicGate();
        $gate->policy(AccessGateTestDummy::class, AccessGateTestPolicy::class);
    ...
    {
        return new Gate($this->app, function () { return (object) ['id' => 1]; });
    }
}
